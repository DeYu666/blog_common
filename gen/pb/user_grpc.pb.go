...
func (c *userServiceClient) FindUsers(ctx context.Context, in *FindUsersRequest, opts ...grpc.CallOption) (*FindUsersReply, error) {
...
func (UnimplementedUserServiceServer) FindUsers(context.Context, *FindUsersRequest) (*FindUsersReply, error) {
